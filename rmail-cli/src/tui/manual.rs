...
pub const PAGES: &[Page] = &[
    ...
    Page {
        anchor: "daemon-control",
        title: "Driving the daemon",
        body: Body::Authored(include_str!("manual/pages/daemon-control.md")),
        documents: &[
            "index status",
            "index run",
            "index reindex",
    ...
    Page {
        anchor: "tags-and-rules",
        title: "Tags and rules",
        body: Body::Authored(include_str!("manual/pages/tags-and-rules.md")),
        documents: &[
            "tag add",
            "tag rm",
            "tag list",
    ...
    Page {
        anchor: "library",
        title: "Notes, saved searches and smart folders",
        body: Body::Authored(include_str!("manual/pages/library.md")),
        documents: &[
            "note add",
            "note list",
            "note edit",
    ...
    Page {
        anchor: "automation",
        title: "Webhooks, hooks and notifications",
        body: Body::Authored(include_str!("manual/pages/automation.md")),
        documents: &[
            "webhook list",
            "webhook add",
            "webhook rm",
    ...
    Page {
        anchor: "accounts-and-tokens",
        title: "Accounts and tokens",
        body: Body::Authored(include_str!("manual/pages/accounts-and-tokens.md")),
        documents: &[
            "account list",
            "account show",
            "account add",
